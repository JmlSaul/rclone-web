...
export function RemotesDetailsPage() {
    ...
    return (
        <section className="relative flex h-full min-h-0 w-full overflow-hidden">
            ...
            {transferSource ? (
                <div className="absolute inset-x-3 bottom-[calc(0.75rem+env(safe-area-inset-bottom))] z-10 rounded-xl border bg-background/95 p-3 shadow-lg backdrop-blur md:hidden">
                    <TransferPanel
                        source={transferSource}
